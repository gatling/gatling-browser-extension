  ...
  request: {
    ...
    headers: [
      ...
      },
      {
        name: ":path",
        value:
          "/css?family=Montserrat:500,600|Varela|Nothing+You+Could+Do|Lora",
      },
      {
        name: ":scheme",
        value: "https",
  ...
  response: {
    ...
    headers: [
      ...
      },
      {
        name: "report-to",
        value:
          '{"endpoints":[{"url":"https:\\/\\/a.nel.cloudflare.com\\/report\\/v3?s=6INZ12dJFYOeOJWP4JybCCoWu0Kkn%2FIvotB6ppmUFGRIrgsevXlFFBGZLBp7cc2A9PVagGYWqm3mdcNmhdy7qSz%2F1H49jLPwxeea2Bd92GYQ3bZ%2Fve0UZ8XPoV7A3b1wfij7x3qdOK04LMCyotttx0Y5"}],"group":"cf-nel","max_age":604800}',
      },
      {
        name: "server",
        value: "cloudflare",
      ...
      },
      {
        name: "x-amz-id-2",
        value:
          "NKtejWTDzoYetfaQsUxrPXJ4auDCFI47GP8jPLyO+uBrALMJRvhnixTSyiKEe/FKi08tIvqbTXU=",
      },
      {
...
describe("mergeRedirectionRequests", () => {
  it("should return 3 requests", () => {
    expect(
      mergeRedirectionRequests([entry1, entry2, entry3, entry4, entry5])
    ).toEqual([entry1, mergedEntry234, entry5]);
  });
});
